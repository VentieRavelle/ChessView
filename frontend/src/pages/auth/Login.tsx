...
import { MoreHorizontal, Github, Facebook, Twitch, Twitter, Apple } from 'lucide-react';
      ...
      <div className="auth-page">
        <div className="auth-visual">
          ...
          <div className="visual-content">
            ...
            <h1>Mastery continues <br/> with every login</h1>
            <p>Welcome back! Sign in to analyze your moves and track progress.</p>
          </div>
        </div>
